...
# Running the program
The Windows version of the program can be run by simply opening the application. The Linux version can be run by using the appimage (just double click it). You may need to first set the appimage to executable. To do this, (1) right-click the appimage, (2) select *Properties*, (3) select the *Permissions* tab, and check *Is executable*.
